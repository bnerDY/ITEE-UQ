...
public class CompareTest {
	...
	public void ComPareTest(){
		...
		int dcm=5,pcm=5,ds=20,dm=40,ps=10,pm=40,dcs=3,pcs=3;
	...
	/*	System.out.println("Random Test: dc="+String.valueOf(dc)+" pc="+String.valueOf(pc));*/
		...
		boolean TestResult1=NaiveAllocator.canAllocate(actualDonations, actualProjects);
		Assert.assertEquals(TestResult1, TestResult);
