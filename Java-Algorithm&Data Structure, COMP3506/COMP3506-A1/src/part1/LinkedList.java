...
public class LinkedList<E> implements PositionList<E> {
	...
	public void addFirst(E e) {
		...
		if (head != null) {
			...
			//This else statement is required otherwise tail 
			//is not updated to point to the first element
			tail = n;
		}
		head = n;
		size++;
	...
	public void addLast(E e) {
		...
		if (tail != null) {
			...
			//This else statement is required otherwise head 
			//is not updated to point to the first element
			head = n;
		}
		tail = n;
	...
	public void addAfter(Position<E> p, E e) throws IllegalArgumentException {
		...
		if (a == null) {
			...
			a.setPrev(n);// set the n to a, if a != null.
		}
		b.setNext(n);
		size++;
	}
	...
	public void addBefore(Position<E> p, E e) throws IllegalArgumentException {
		...
		a.setPrev(n); // set previous n to a
		size++;
	}
